...
After forking the repo, the documentation will still have the SE-EDU branding and refer to the `cs2103-ay1819s2-w14-4/main` repo.

If you plan to develop this fork as a separate product (i.e. instead of contributing to `cs2103-ay1819s2-w14-4/main`), you should do the following:
...
=======
>>>>>>> 4005dafb42ab545b0a4bc88e7f392bd3e3ef7ca9
==== Setting up CI
